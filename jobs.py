...
jobs = [
    {'id': 0, 'title': "AI Engineer", 'company': 'Microsoft', 'salary': 95000, 'state_date': '12/4/2026', 'description': """Overview: We are seeking an AI Engineer to bridge the gap between machine learning research and scalable production applications. You will focus on integrating Large Language Models (LLMs) into our core products to automate complex workflows.
...
Conduct code reviews and maintain high standards for UI/UX consistency and unit testing."""},
    {'id': 2, 'title': "Front Engineer", 'company': 'Meta', 'salary': 75000, 'state_date': '23/3/2026', 'description': """Overview: We are looking for a Backend Engineer to build the robust, scalable architecture that powers our application. You will handle the "heavy lifting"—from database design to third-party integrations and system security.
